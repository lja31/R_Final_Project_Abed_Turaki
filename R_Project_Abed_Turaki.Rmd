...
dataset2.ts <- ts(as.numeric(dataset2$Domestic_general_government_health_expenditure_per_capita), start = c(2000, 1), end = c(2021, 1), frequency=1)

# Decomposing the annual time series
dataset2.ts.decomp <- stl(dataset2.ts, s.window = "periodic")

# Plotting the components
plot(dataset2.ts.decomp)

library(trend)

# Running the Seasonal Mann-Kendall test
result <- smk.test(dataset2.ts)
